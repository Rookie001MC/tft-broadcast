...
**Note:** most assets from `rcp-be-lol-game-data` can be found in both LCU files and game client files.
 ...
 - [Skin splash arts and square portraits (all skins, all variants)](https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/assets/characters/): `plugins/rcp-be-lol-game-data/global/default/assets/characters/{name}/skins/{skin}` ([example](https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/assets/characters/lux/skins/skin70/)
